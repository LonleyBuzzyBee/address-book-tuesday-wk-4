...
function displayContactDetails(addressBookToDisplay) {
  ...
  addressBookToDisplay.contacts.forEach(function(contact) {
    htmlForContactInfo += "<div class='card card-body text-white bg-info'><li id=" + contact.id + ">" + contact.firstName + " " + contact.lastName + "</li></div>";
  });
...
function showContact(contactId) {
  ...
  // removeEmptyFields(contact.address);
  var buttons = $("#buttons");
  buttons.empty();
  buttons.append("<button class='btn btn-info deleteButton' id=" + contact.id + ">Delete</button>");
}

function removeEmptyFields(contact) {
